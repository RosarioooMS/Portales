...
LOGO_PATH = os.path.join(BASE_DIR, "logo.png")  # Coloca logo.png en el mismo directorio que main.py
FONDO_PATH = os.path.join(BASE_DIR, "depa.png") # Coloca depa.png en el mismo directorio que main.py
...
def crear_tabla_financiamiento(filtrados, grupo):
    ...
    if grupo == "Grupo 1":
        filas = [
            "Contado", "Cierre de Proforma CO", "Crédito Hipotecario cuota inicial completa",
        ...
        porcentajes_logro = {
            "Contado": "", "Cierre de Proforma CO": "100%", "Crédito Hipotecario cuota inicial completa": "",
        ...
        mapping = {
            "Cierre de Proforma": {"CO":"Cierre de Proforma CO","CIC":"Cierre de Proforma CIC",
        ...
        filas = ["Plan Ahorro - Hasta 9 Meses", "Cierre Plan Ahorro - Mixto", 
                 "Fin de pago de cuotas de plan Ahorro", "Desembolso"]
        porcentajes_logro = {
            "Plan Ahorro - Hasta 9 Meses": "", "Cierre Plan Ahorro - Mixto": "60%",
            "Fin de pago de cuotas de plan Ahorro": "10%", "Desembolso": "30%"
        }
        mapping = {
            "Cierre de Proforma":{"CO":"Plan Ahorro - Hasta 9 Meses","PA":"Cierre Plan Ahorro - Mixto"},
        ...
        filas = ["Plan Ahorro - Hasta 6 Meses", "Cierre Plan Ahorro - Mixto", 
                 "Fin de pago de cuotas de plan Ahorro", "Desembolso"]
        porcentajes_logro = {
            "Plan Ahorro - Hasta 6 Meses": "", "Cierre Plan Ahorro - Mixto": "60%",
            "Fin de pago de cuotas de plan Ahorro": "10%", "Desembolso": "30%"
        }
        mapping = {
            "Cierre de Proforma":{"CO":"Plan Ahorro - Hasta 6 Meses","PA":"Cierre Plan Ahorro - Mixto"},
            "Fin de pago de cuota inicial":"Fin de pago de cuotas de plan Ahorro",
            "Desembolso":"Desembolso"
        }
        columnas_usar = ["Cierre de Proforma","Fin de pago de cuota inicial","Desembolso"]
...
def crear_tabla_tipo_unid(filtrados, proyecto):
    ...
    tabla = pd.DataFrame(index=["Pago spot por venta de Estacionamiento","Pago spot por cada venta de Depósito"], columns=columnas_finales)
...
if archivo:
    ...
    proyectos = [
        'GRAN GUARDIA PERUANA - ETAPA 1','MF GRAN PLAZA LORETO','GRAN CENTRAL COLONIAL 2 -  ETAPA I',
    ...
    if st.button("📊 Crear Tablas Financiamiento"):
        ...
        if filtrados.empty:
            ...
            for tabla, titulo in [(tabla1,"Tabla Financiamiento - Grupo 1"),
